# README: 똑똑옷장 - 날씨 기반 맞춤형 의상 추천 시스템
...
## 개발 환경
- **언어 및 프레임워크:** Java, Spring Boot, React, TypeScript, Node.js  
- **데이터베이스:** MySQL  
...
## 시연 영상
프로젝트의 기능과 사용법을 보여주는 시연 영상을 첨부하였습니다.
...
**똑똑옷장과 함께 더 편리하고 자신 있는 하루를 시작해 보세요!**
